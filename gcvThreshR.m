...
%   Last time modified: July, 22, 2017
%---------------------------------------------------------------------------
...
function [dn] = gcvThreshR(data,opt)
